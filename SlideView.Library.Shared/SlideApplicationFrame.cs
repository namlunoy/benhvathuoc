...
namespace SlideView.Library
{
...
#endif
    {
        ...
        public const int IndexLeftPanel = 0;
        public const int IndexCenterPanel = 1;
        public const int IndexRightPanel = 2;
        ...
        public static readonly DependencyProperty IsSlideEnabledProperty =
            ...
            new PropertyMetadata(true, new PropertyChangedCallback(OnIsSlideEnabledChanged)));
        ...
        protected virtual void OnIsSlideEnabledChanged()
        {
            ...
            if (_leftButton != null)
                _leftButton.IsEnabled = IsSlideEnabled;

            if (_rightButton != null)
                _rightButton.IsEnabled = IsSlideEnabled;
        }
        ...
        {
            if (SelectedPanelIndex != IndexRightPanel)
                SelectedPanelIndex = IndexRightPanel;
            else
                SelectedPanelIndex = IndexCenterPanel;
        }
        ...
        {
            if (SelectedPanelIndex != IndexLeftPanel)
                SelectedPanelIndex = IndexLeftPanel;
            else
                SelectedPanelIndex = IndexCenterPanel;
        }
